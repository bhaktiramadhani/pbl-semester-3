...
<script>
    $(function() {
        $(".delete-product").on("click", function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location.href = `<?= BASEURL ?>/dashboard/hapus_product/${productId}`;
                }
            });
        });
        ...
        $(".edit-produk").on("click", function() {
            ...
            $.ajax({
                url: "<?= BASEURL ?>/dashboard/getEditProduct",
                data: {
                    id: id,
                },
                method: "post",
                ...
                success: function(data) {
                    ...
                    $("#modal-img").attr(
                        "src",
                        `<?= BASEURL ?>/images/produk/${data.image}`
                    );
        ...
        $("#search").change(function() {
            $("#form-search").attr(
                "action",
                `<?= BASEURL ?>/dashboard/products/${$(this).val()}`
            );
        });
    });
