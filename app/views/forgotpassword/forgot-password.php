...
<body>
    <div class="w-full h-screen flex flex-col justify-center items-center mx-auto max-w-xs">
        ...
        <a href="login.php" class="self-start flex gap-2 items-center  rounded-md mb-4 group" data-tooltip-target="tooltip-to-home">
        ...
        <form class="flex flex-col justify-center w-full" action="handler/send_forgot_password.php" method="POST">
            <div class="relative z-0 w-full mb-6 group">
                <input type="email" name="gmail" id="gmail" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-brown peer" placeholder=" " required />
            ...
            <button type="submit" class="text-white bg-brown hover:bg-brownHover focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-all duration-200 ease-in-out" name="submit">Send</button>
        </form>
    </div>
