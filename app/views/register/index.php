<div class="w-full h-screen flex flex-col justify-center items-center mx-auto max-w-xs">
    ...
    <form class="flex flex-col justify-center w-full" action="register/verify_register" method="POST">
        ...
        <div class="relative z-0 w-full mb-6 group">
            <input type="password" name="confirm_password" id="confirm_password" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-brown peer" placeholder=" " required />
    ...
    <a href="login" class="self-start mt-4 font-normal underline underline-offset-4 hover:no-underline text-sm">Ke halaman Login</a>
</div>
