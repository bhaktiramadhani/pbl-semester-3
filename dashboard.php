    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="dashboard.php" class="flex items-center p-2 text-gray-900 rounded-lg  bg-gray-100  group">
                ...
                <li>
                    <a href="products.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <div class="grid justify-items-center grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-y-6 max-w-5xl">
                        <a href='#' class="w-60 h-auto">
                            <div class="flex justify-between pt-6 pb-[50px] px-7 bg-slate-400 rounded-t-md">
                                ...
                                <img src="assets/images/icons/bestbuy.svg" alt="logo best seller" width="40" height="38" class="pt-[14px]">
                            </div>
                            <div class="bg-black text-white text-center py-2 rounded-b-md">
                                <p>Selengkapnya</p>
                            </div>
                        </a>
                        <a href='products.php' class="w-60 h-auto">
                            <div class="flex justify-between pt-6 pb-[50px] px-7 bg-slate-400 rounded-t-md">
                                <div>
                                    <span class="font-bold text-lg"><?= count($products); ?></span>
