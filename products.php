                            ...
                            <?php foreach ($products as $product) : ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 space-y-2">
                                        ...
                                        <a href="handler/hapus_data.php?hapus=<?= $product['id_products'] ?>" onclick="return confirm('Apakah anda yakin ingin menghapus produk ini?')" class="font-medium text-white bg-red-600 hover:bg-red-500 py-2 px-4 rounded-lg inline-block">Hapus</a>
                                    </td>
                                </tr>
